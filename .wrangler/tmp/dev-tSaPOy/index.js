...
var require_bindings = __commonJS({
  "node_modules/bindings/bindings.js"(exports, module) {
    ...
    exports.getFileName = /* @__PURE__ */ __name(function getFileName(
      calling_file,
    ) {
    ...
    exports.getRoot = /* @__PURE__ */ __name(function getRoot(file) {
      ...
      while (true) {
        ...
        if (
          exists2(join(dir3, "package.json")) ||
          exists2(join(dir3, "node_modules"))
        ) {
          return dir3;
        }
        if (prev === dir3) {
...
var require_wrappers = __commonJS({
  "node_modules/better-sqlite3/lib/methods/wrappers.js"(exports) {
    ...
    exports.exec = /* @__PURE__ */ __name(function exec(sql2) {
    ...
    exports.loadExtension = /* @__PURE__ */ __name(function loadExtension(
      ...args
    ) {
      this[cppdb].loadExtension(...args);
      return this;
    }, "loadExtension");
    exports.defaultSafeIntegers = /* @__PURE__ */ __name(
      function defaultSafeIntegers(...args) {
...
var require_transaction = __commonJS({
  "node_modules/better-sqlite3/lib/methods/transaction.js"(exports, module) {
    ...
    module.exports = /* @__PURE__ */ __name(function transaction(fn) {
    ...
    var wrapTransaction = /* @__PURE__ */ __name(
      (
        apply,
        fn,
        db,
        { begin, commit, rollback, savepoint, release: release2, rollbackTo },
      ) =>
        /* @__PURE__ */ __name(function sqliteTransaction() {
...
var require_pragma = __commonJS({
  "node_modules/better-sqlite3/lib/methods/pragma.js"(exports, module) {
    ...
    module.exports = /* @__PURE__ */ __name(function pragma(source, options) {
...
var require_backup = __commonJS({
  "node_modules/better-sqlite3/lib/methods/backup.js"(exports, module) {
    ...
    module.exports = /* @__PURE__ */ __name(async function backup(
      filename,
      options,
    ) {
      if (options == null) options = {};
...
var require_serialize = __commonJS({
  "node_modules/better-sqlite3/lib/methods/serialize.js"(exports, module) {
    ...
    init_performance2();
    var { cppdb } = require_util();
    module.exports = /* @__PURE__ */ __name(function serialize2(options) {
      if (options == null) options = {};
      if (typeof options !== "object")
...
var require_function = __commonJS({
  "node_modules/better-sqlite3/lib/methods/function.js"(exports, module) {
    ...
    init_performance2();
    var { getBooleanOption, cppdb } = require_util();
    module.exports = /* @__PURE__ */ __name(function defineFunction(
      name,
      options,
      fn,
    ) {
...
var require_aggregate = __commonJS({
  "node_modules/better-sqlite3/lib/methods/aggregate.js"(exports, module) {
    ...
    init_performance2();
    var { getBooleanOption, cppdb } = require_util();
    module.exports = /* @__PURE__ */ __name(function defineAggregate(
      name,
      options,
    ) {
      if (typeof name !== "string")
...
var require_table = __commonJS({
  "node_modules/better-sqlite3/lib/methods/table.js"(exports, module) {
    ...
    init_performance2();
    var { cppdb } = require_util();
    module.exports = /* @__PURE__ */ __name(function defineTable(
      name,
      factory,
    ) {
      if (typeof name !== "string")
    ...
    function wrapFactory(factory) {
      return /* @__PURE__ */ __name(function virtualTableFactory(
        moduleName,
        databaseName,
        tableName,
        ...args
    ...
    function wrapGenerator(generator, columnMap, moduleName) {
      return /* @__PURE__ */ __name(function* virtualTable(...args) {
        const output = args.map((x) =>
          Buffer.isBuffer(x) ? Buffer.from(x) : x,
        );
    ...
    var identifier = /* @__PURE__ */ __name(
      (str) => `"${str.replace(/"/g, '""')}"`,
      "identifier",
    );
...
var require_inspect = __commonJS({
  "node_modules/better-sqlite3/lib/methods/inspect.js"(exports, module) {
    ...
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
    init_performance2();
    var DatabaseInspection = /* @__PURE__ */ __name(
      function Database2() {},
      "Database",
    );
    module.exports = /* @__PURE__ */ __name(function inspect(depth, opts) {
...
// .wrangler/tmp/bundle-OJYrxI/middleware-loader.entry.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// .wrangler/tmp/bundle-OJYrxI/middleware-insertion-facade.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
var PgArrayBuilder = class extends PgColumnBuilder {
  ...
  build(table3) {
    ...
    return new PgArray(table3, this.config, baseColumn);
  }
};
...
var PgEnumColumnBuilder = class extends PgColumnBuilder {
  ...
  /** @internal */
  build(table3) {
    return new PgEnumColumn(table3, this.config);
  }
};
...
function text(name, config2 = {}) {
  return config2.mode === "json"
    ? new SQLiteTextJsonBuilder(name)
    : new SQLiteTextBuilder(name, config2);
}
__name(text, "text");
...
var SQLiteDialect = class {
  ...
  buildSelectQuery({
    ...
    const tableSql = (() => {
      if (
        is(table3, Table) &&
        table3[Table.Symbol.OriginalName] !== table3[Table.Symbol.Name]
      ) {
...
var tasks = sqliteTable("tasks", {
  ...
  // 'revenue' | 'growth' | 'operations' | 'strategic' | 'personal'
  timeBlock: text("time_block").notNull(),
  // 'deep' | 'collaborative' | 'quick' | 'systematic'
  // Time & Decision
  ...
  isInFocus: integer("is_in_focus", { mode: "boolean" }).default(false),
  // currently in focus mode
  focusStartedAt: integer("focus_started_at", { mode: "timestamp" }),
  // when current focus session started
  targetDuration: integer("target_duration"),
  // countdown timer target in minutes
  isPaused: integer("is_paused", { mode: "boolean" }).default(false),
  // whether timer is currently paused
  pausedTime: integer("paused_time").default(0),
  // accumulated pause time in seconds
  pauseStartTime: integer("pause_start_time", { mode: "timestamp" }),
...
var timeEntries = sqliteTable("time_entries", {
  ...
  // in minutes, calculated when session ends
  type: text("type").notNull().default("regular"),
  // 'focus' | 'regular'
  // Focus session details
  quote: text("quote"),
  // motivational quote for focus sessions
  // Timestamps
  createdAt: integer("created_at", { mode: "timestamp" }).notNull(),
  updatedAt: integer("updated_at", { mode: "timestamp" }).notNull(),
});
...
var notes = sqliteTable("notes", {
  ...
  // markdown format
  // Categorization
  category: text("category").notNull().default("task-note"),
  // 'daily-log' | 'task-note' | 'reflection' | 'idea' | 'meeting'
  tags: text("tags"),
  // JSON array of strings
  // AI-ready metadata
  metadata: text("metadata"),
  // JSON: { mood?, energy?, location?, context? }
  // Timestamps
  createdAt: integer("created_at", { mode: "timestamp" }).notNull(),
  updatedAt: integer("updated_at", { mode: "timestamp" }).notNull(),
});
...
function createDB(env2) {
  if (env2.NODE_ENV === "demo") {
    return null;
  }
  if (env2.NODE_ENV === "development" || !env2.DB) {
    const sqlite = new import_better_sqlite32.default("./dev.db");
    return drizzle2(sqlite, { schema: schema_exports });
  }
...
var accessMiddleware = createMiddleware(async (c, next) => {
  ...
  try {
    ...
    console.error("Access middleware error:", error3);
...
// node_modules/@hono/zod-validator/dist/esm/index.js
var zValidator = /* @__PURE__ */ __name(
  (target, schema, hook) =>
...
var createTaskSchema = external_exports.object({
  ...
  impact: external_exports.number().int().min(1).max(10),
  confidence: external_exports.number().int().min(1).max(10),
  ease: external_exports.number().int().min(1).max(10),
  ...
  timeBlock: external_exports.enum([
    "deep",
    "collaborative",
    "quick",
    "systematic",
  ]),
  estimatedTime: external_exports.number().int().min(5).max(1440),
  // 5 minutes to 24 hours
  decision: external_exports.enum(["do", "delegate", "delay", "delete"]),
  scheduledFor: external_exports
    .enum(["today", "this-week", "this-month", "someday"])
    .or(external_exports.literal(""))
    .optional()
    .transform((val) => (val === "" ? void 0 : val)),
  recurringPattern: external_exports
...
var updateTaskSchema = createTaskSchema.partial().extend({
  status: external_exports.enum(["active", "completed", "archived"]).optional(),
  lastCompletedDate: external_exports
    .string()
    .or(external_exports.date())
    .optional(),
  streakCount: external_exports.number().int().min(0).optional(),
  isInFocus: external_exports.boolean().optional(),
  focusStartedAt: external_exports
    .string()
    .or(external_exports.date())
    .nullable()
    .optional(),
  actualTime: external_exports.number().int().min(0).optional(),
});
var updatePreferencesSchema = external_exports.object({
  preferredMethod: external_exports.string().optional(),
  defaultTimeBlock: external_exports.string().optional(),
});
var taskQuerySchema = external_exports.object({
  status: external_exports.enum(["active", "completed", "archived"]).optional(),
  timeBlock: external_exports
    .enum(["deep", "collaborative", "quick", "systematic", "all"])
    .optional(),
  limit: external_exports
    .string()
    .transform(Number)
    .pipe(external_exports.number().int().min(1).max(100))
    .optional(),
});
var recommendationQuerySchema = external_exports.object({
  method: external_exports
    .enum([
      "simple",
      "weighted",
      "roi",
...
tasksRouter.post("/", zValidator("json", createTaskSchema), async (c) => {
  if (c.env.NODE_ENV === "demo") {
    const taskData2 = c.req.valid("json");
    const mockTask = {
      id: Date.now(),
      ...taskData2,
      userId: 1,
...
tasksRouter.get("/:id", async (c) => {
  ...
  try {
    ...
    console.error("Get task error:", error3);
...
tasksRouter.put("/:id", zValidator("json", updateTaskSchema), async (c) => {
  ...
  try {
    ...
    console.error("Update task error:", error3);
...
tasksRouter.delete("/:id", async (c) => {
  ...
  try {
    ...
    console.error("Delete task error:", error3);
...
tasksRouter.patch("/:id/focus/start", async (c) => {
  if (c.env.NODE_ENV === "demo") {
    return c.json({
      task: {
        ...
        isInFocus: true,
        focusStartedAt: /* @__PURE__ */ new Date(),
      },
    });
  }
  const id = parseInt(c.req.param("id"));
  ...
  try {
    ...
    console.error("Start focus session error:", error3);
    return c.json({ error: "Failed to start focus session" }, 500);
  }
});
tasksRouter.patch("/:id/focus/end", async (c) => {
  if (c.env.NODE_ENV === "demo") {
    const { duration: duration2 } = await c.req.json();
    return c.json({
      task: {
        id: parseInt(c.req.param("id")),
        isInFocus: false,
        focusStartedAt: null,
        actualTime: duration2,
      },
    });
  }
  const id = parseInt(c.req.param("id"));
  ...
  try {
    ...
    console.error("End focus session error:", error3);
...
tasksRouter.post("/:id/time", async (c) => {
  ...
  try {
    ...
    console.error("Add time entry error:", error3);
...
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var preferencesRouter = new Hono2();
...
preferencesRouter.get("/", async (c) => {
  ...
  try {
    ...
    console.error("Get preferences error:", error3);
...
preferencesRouter.put(
  ...
  async (c) => {
    ...
    try {
      ...
      console.error("Update preferences error:", error3);
      return c.json({ error: "Failed to update preferences" }, 500);
    }
  },
);
var preferences_default = preferencesRouter;
...
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var calculateICE = /* @__PURE__ */ __name((task) => {
  return ((task.impact + task.confidence + task.ease) / 3).toFixed(1);
}, "calculateICE");
var getDecisionRecommendation = /* @__PURE__ */ __name(
  (task, selectedMethod = "hybrid") => {
    ...
    if (selectedMethod === "strategic") {
      ...
      const strategicValue = (typeWeights[task.type] || 1) * impact;
    ...
    if (selectedMethod === "hybrid") {
      ...
      const strategicWeight = typeWeights[task.type] || 1;
...
statsRouter.get("/overview", async (c) => {
  ...
  try {
    ...
    userTasks.forEach((task) => {
      const time3 = task.estimatedTime || 0;
      totalTime += time3;
      if (decisions[task.decision]) {
        decisions[task.decision].count++;
        decisions[task.decision].time += time3;
      }
      if (timeBlocks[task.timeBlock]) {
        timeBlocks[task.timeBlock].count++;
        timeBlocks[task.timeBlock].time += time3;
      }
      if (types[task.type]) {
        types[task.type].count++;
        types[task.type].time += time3;
      }
    });
    const stats = {
      decisions,
    ...
    console.error("Get overview stats error:", error3);
...
var createNoteSchema = external_exports.object({
  taskId: external_exports.number().optional().nullable(),
  ...
  metadata: external_exports
    .object({
      mood: external_exports
        .enum(["great", "good", "neutral", "tired", "stressed"])
        .optional(),
      energy: external_exports.enum(["high", "medium", "low"]).optional(),
...
var noteQuerySchema = external_exports.object({
  category: external_exports
    .enum(["daily-log", "task-note", "reflection", "idea", "meeting"])
    .optional(),
...
notesRouter.get("/", zValidator("query", noteQuerySchema), async (c) => {
  ...
  try {
    ...
    const parsedNotes = filteredNotes.map((note) => ({
      ...
      metadata: note.metadata ? JSON.parse(note.metadata) : void 0,
    }));
...
notesRouter.get("/:id", async (c) => {
  ...
  try {
    ...
    console.error("Failed to fetch note:", error3);
...
notesRouter.post("/", zValidator("json", createNoteSchema), async (c) => {
  ...
  try {
    ...
    const parsedNote = {
      ...
      metadata: result.metadata ? JSON.parse(result.metadata) : void 0,
    };
    return c.json({ note: parsedNote }, 201);
  } catch (error3) {
    console.error("Failed to create note:", error3);
...
notesRouter.put("/:id", zValidator("json", updateNoteSchema), async (c) => {
  ...
  try {
    ...
    if (noteData.title !== void 0) updateData.title = noteData.title;
    if (noteData.content !== void 0) updateData.content = noteData.content;
    if (noteData.category !== void 0) updateData.category = noteData.category;
    if (noteData.taskId !== void 0) updateData.taskId = noteData.taskId;
    if (noteData.tags !== void 0)
      updateData.tags = JSON.stringify(noteData.tags);
    if (noteData.metadata !== void 0)
    ...
    console.error("Failed to update note:", error3);
...
notesRouter.delete("/:id", async (c) => {
  ...
  try {
    ...
    console.error("Failed to delete note:", error3);
    return c.json({ error: "Failed to delete note" }, 500);
  }
});
var notes_default = notesRouter;
...
app.route("/api/preferences", preferences_default);
app.route("/api/stats", stats_default);
app.route("/api/notes", notes_default);
